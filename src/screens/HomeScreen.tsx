...
const st = themed(() => StyleSheet.create({
  ...
  item: { marginBottom: C.sp.cardGap },
  itemHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: S.md, paddingVertical: C.sp.item, paddingHorizontal: C.sp.pad, backgroundColor: C.card2, borderRadius: C.cardRadius, borderLeftWidth: 3, borderLeftColor: C.accent },
